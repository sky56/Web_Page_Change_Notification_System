...
class Diff{
  ...
  public static function toTable($diff, $indentation = '', $separator = '<br>'){
    ...
    // loop over the lines in the diff
    $index = 0;
	$file1 = fopen('/opt/lampp/htdocs/left.html','w');
	$file2 = fopen('/opt/lampp/htdocs/right.html','w');
    while ($index < count($diff)){
      ...
      switch ($diff[$index][1]){
        ...
        case self::UNMODIFIED:
          ...
          $rightCell = $leftCell;
		  fwrite($file1,$leftCell);
		  fwrite($file2,$rightCell);
		 // echo $rightCell;
		  //$temp2 =  file_get_contents('$rightCell');
		  //file_put_contents('le.html',$rightCell);
          break;
        ...
        case self::DELETED:
          ...
          $rightCell =
              self::getCellContent(
				  ...
				  $new1 = "<div style='color:red'>";
				  //$new1 =  htmlspecialchars($new1);
				  fwrite($file1,$new1);
				  fwrite($file1,$leftCell);
				  $new2 = "</div>";
				  //$new2 =  htmlspecialchars($new2);
				  fwrite($file1,$new2);
			      $new3 = "<div style='color:green'>";
				  //$new3 =  htmlspecialchars($new3);
				  fwrite($file2,$new3);
				  fwrite($file2,$rightCell);
				  $new4 = "</div>";
				  //$new4 =  htmlspecialchars($new4);
				  fwrite($file2,$new4);
          break;
